...
/*   Updated: 2023/01/24 16:49:14 by mpignet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_heredoc(t_data *data)
{
	...
	tmp_fd = open("/tmp/.heredoc.tmp", O_WRONLY | O_CREAT | O_TRUNC, 0644);
	if (tmp_fd < 0)
		clean_exit(data, 1);
